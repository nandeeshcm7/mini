...
<?php
       if ($_POST['submit']){
        ...
        if($query){
          ...
          $_SESSION['id']=$userId;
		  echo $dbusername;
		  echo "dbusername<span style='color:red;'>dbusername hhvjhjgjkhUser name or password is incorrect!</span>";
               ...
               <div class="row">
                    <div class="templatemo-line-header" style="margin-top: 40px;" >
                        <div class="text-center">
                            <hr class="team_hr team_hr_left hr_gray"/><span class="span_blog txt_darkgrey txt_orange">Welcome to ADMIN</span>
