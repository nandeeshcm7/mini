...
<?php
       if ($_POST['submit']){
		...
		header('Location:localhost/AttendenceReportemp.php?variable=$username,$password');

        $sql="SELECT id, username, password FROM usersemp WHERE username='$username'";
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action="loginemp.php">
